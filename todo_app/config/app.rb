...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'todo-app.com'
  config.app_name = 'Todo_app'
  config.mailer.from = 'Todo_app <no-reply@todo-app.com>'
  ...
  #
  config.app_secret = 'LW0WDHQe4G8sCdOLuZqrd0C5nJbPolvQjEcKtZJevA-lNho5aO5Eod1cHmhuxg1EOFQ'
